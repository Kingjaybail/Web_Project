...
def process_bagging_regression(file: bytes, filename: str, target_column: str, metrics_list=None):
    ...
    if model_type == "regression":
        ...
        model = BaggingClassifier(estimator=base_model, n_estimators=10, random_state=42, n_jobs=-1)
    ...
    return {
        "model_type": "Bagging Regression" if model_type == "regression" else "Bagging Classification",
        "metrics": results,
